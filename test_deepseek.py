"""Тестовый скрипт для проверки только части DeepSeek на существующей транскрипции"""
...
async def test_deepseek_extraction(
    ...
    # Загружаем конфигурацию DeepSeek
    try:
        deepseek_config = DeepSeekConfig.from_file()
        logger.info(f"✅ Конфигурация DeepSeek загружена: {deepseek_config.base_url}")
    except Exception as e:
