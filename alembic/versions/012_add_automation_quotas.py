...
def upgrade() -> None:
    ...
    op.add_column("user_quotas", sa.Column("max_automation_jobs", sa.Integer(), nullable=False, server_default="5"))
    op.add_column(
        "user_quotas", sa.Column("min_automation_interval_hours", sa.Integer(), nullable=False, server_default="1")
    )
