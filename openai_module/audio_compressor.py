"""Сжатие аудио файлов для Whisper API"""
...
class AudioCompressor:
    """Компрессор аудио для уменьшения размера файла до лимита Whisper API (25 МБ)"""
    ...
    async def compress_audio(
        ...
        """
        Сжатие аудио файла для Whisper API.
        ...
        # Но лучше все равно сжать до оптимальных параметров для Whisper
    ...
    async def split_audio(
        ...
        Args:
            ...
            max_size_mb: Максимальный размер одной части в МБ (с запасом от 25 МБ)
        ...
        async def create_part(i: int) -> str:
            ...
            try:
                ...
                if part_size_mb > self.max_file_size_mb:
                    error_msg = (
                        f"Часть {i+1}/{num_parts} превышает лимит Whisper API: "
